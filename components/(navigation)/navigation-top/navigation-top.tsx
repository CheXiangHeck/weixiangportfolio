...
import { InfoIcon, LucideIcon, FileIcon, TargetIcon, FolderIcon, ActivityIcon, GithubIcon, LinkedinIcon, PhoneCallIcon, MailIcon } from "lucide-react";
        ...
        <TooltipProvider>
            <NavigationMenu className="justify-start">
                <NavigationMenuList className="flex gap-2">
                                    ...
                                    <NavigationMenuLink asChild>
                                        ...
                                        >
                                            ...
                                            <p className="text-sm dark:text-slate-300 mx-4 font-Oswald">
                                                I am a Software Engineering student from Asia Pacific University of Innovation & Technology. Click here to learn more about me.
                                            </p>
                                        </a>
                                    </NavigationMenuLink>
                                </li>
                                    ...
                                    <div className="w-full h-full rounded-md p-2 flex flex-col overflow-y-scroll scrollbar gap-3">
                                        {components.map((component) => (
                                            <NavigationMenuLink asChild key={component.title}>
                                                <a className=" flex bg-slate-500 p-3 rounded-md hover:bg-indigo-500" href={component.href}>
                    ...
                    <NavigationMenuItem>
                        <NavigationMenuLink asChild>
                            <a className="flex w-[128.53px] h-[40px] items-center justify-center hover:opacity-50 hover:bg-zinc-800  rounded-md" href="/status">
                    ...
                    <NavigationMenuItem className="flex gap-3 w-full p-3 dark:bg-neutral-500 h-full rounded-md">
                        <NavigationMenuLink asChild>
                            <Tooltip>
                                <TooltipTrigger>
                                    <a className="w-24 h-24" href="https://www.linkedin.com/in/wei-xiang-apu/">
                                        <LinkedinIcon/>
                                    </a>
                                </TooltipTrigger>
                                <TooltipContent>
